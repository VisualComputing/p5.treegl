...
(function () {
  ...
  */
  ...
  p5.RendererGL.prototype.vertexShader = function ({
    ...
    // TODO rename color4 (1126 & 1132) and texCoords2 (1127 & 1133)
    ...
    let pName = bind ? 'pMatrix' : 'uProjectionMatrix';
    let v = ~(uniforms | ~Tree.vMatrix) === 0;
    let e = ~(uniforms | ~Tree.eMatrix) === 0;
    let mv = ~(uniforms | ~Tree.mvMatrix) === 0;
    let mvName = bind ? 'mvMatrix' : 'uModelViewMatrix';
    let m = ~(uniforms | ~Tree.mMatrix) === 0;
    let n = (~(uniforms | ~Tree.nMatrix) === 0) || normal3;
  ...
  p5.prototype.readShader = function (fragFilename) {
    ...
    shader._vertSrc = vertexShader({ uniforms: Tree.pMatrix | Tree.mvMatrix, varyings: Tree.color4 | Tree.texCoords2, bind: false });
    this.loadStrings(
      fragFilename,
      result => {
